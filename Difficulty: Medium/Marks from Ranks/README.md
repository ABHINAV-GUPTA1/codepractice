...
<p>&nbsp;</p></div><br><p><span style=font-size:18px><strong>Expected Complexities : </strong><br><code>Time Complexity: O(n + q log n), where n is the number of intervals (l.size()) and q is the number of rank queries (rank.size()).</code>&nbsp;<code>Auxiliary Space: O(n )</code>&nbsp;<br><p><span style=font-size:18px><strong>Topic Tags : </strong><br><code>Arrays</code>&nbsp;<code>Searching</code>&nbsp;