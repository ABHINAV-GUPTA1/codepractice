<h2><a href="https://www.lintcode.com/problem/1017/description">LintCode Similar RGB Color</a></h2><h3>Easy</h3><p>Time: 289 ms | Space: 21.40 MB</p><hr><pre>In the following, every capital letter represents some hexadecimal digit from 0 to f.
